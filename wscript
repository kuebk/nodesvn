...
def build(bld):
  ...
  obj.lib = ['svn_client-1', 'svn_wc-1', 'svn_ra-1', 'svn_ra_svn-1', 'svn_ra_local-1', 'svn_ra_serf-1', 'svn_subr-1', 'svn_delta-1', 'svn_repos-1', 'svn_fs-1', 'svn_fs_fs-1', 'serf-0', 'aprutil-1', 'apr-1', 'expat']
